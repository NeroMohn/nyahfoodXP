...
import java.util.*;
public class RegistraLojaInglesaTest {
  ...
  @Test
  public void registraLojaInglesa() {
    ...
    driver.findElement(By.name("txtDescricaoLoja")).sendKeys("asdas");
    driver.findElement(By.name("optTipoCozinha")).click();
    {
      WebElement dropdown = driver.findElement(By.name("optTipoCozinha"));
      dropdown.findElement(By.xpath("//option[. = 'Inglesa']")).click();
    }
    driver.findElement(By.name("optTipoCozinha")).click();
    driver.findElement(By.name("txtComplementoLoja")).click();
    driver.findElement(By.name("txtComplementoLoja")).sendKeys("app 03");

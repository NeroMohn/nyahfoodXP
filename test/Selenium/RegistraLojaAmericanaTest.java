...
import java.util.*;
public class RegistraLojaAmericanaTest {
  ...
  @Test
  public void registraLojaAmericana() {
    ...
    driver.findElement(By.name("txtSenhaLoja")).sendKeys("1231231232");
    ...
    driver.findElement(By.name("txtDescricaoLoja")).sendKeys("asdasdasdsa");
    driver.findElement(By.name("optTipoCozinha")).click();
    {
      WebElement dropdown = driver.findElement(By.name("optTipoCozinha"));
      dropdown.findElement(By.xpath("//option[. = 'Americana']")).click();
    }
    driver.findElement(By.name("optTipoCozinha")).click();
    driver.findElement(By.name("txtComplementoLoja")).click();
    driver.findElement(By.name("txtComplementoLoja")).sendKeys("app 02");
